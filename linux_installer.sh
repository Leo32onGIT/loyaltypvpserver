...
echo -e "\033[1;37m Welcome To loyaltypvpserver Linux Installer\033[0m"
echo -e "\033[1;37m Bem-vindo ao Instalador loyaltypvpserver Linux\033[0m"
echo -e "\033[1;37m Witamy w Instalatorze loyaltypvpserver Linux\033[0m"
echo -e "\033[1;36m===============================================\033[0m"
echo ""
sleep 2
...
while [[ -z "${lang[Title]}" ]]; do
    ...
    case "$choice" in
        '1')
            lang[Title]="--- Interactive loyaltypvpserver (Canary) Compiler ---"
            ...
            lang[Step4Title]="--- STEP 4: Cloning loyaltypvpserver Source ---"
            lang[Step4Clone]="Cloning loyaltypvpserver repository (branch: %s) into your home directory (~/loyaltypvpserver)..." # %s is a placeholder
            lang[Step4Exists]="loyaltypvpserver directory already exists. Skipping clone."
            ...
            ;;
        '2')
            lang[Title]="--- Compilador Interativo loyaltypvpserver (Canary) ---"
            ...
            lang[Step4Title]="--- PASSO 4: Clonando o Código do loyaltypvpserver ---"
            lang[Step4Clone]="Clonando o repositório loyaltypvpserver (branch: %s) no seu diretório home (~/loyaltypvpserver)..."
            lang[Step4Exists]="O diretório loyaltypvpserver já existe. Pulando clone."
            ...
            ;;
        '3')
            lang[Title]="--- Interaktywny Kompilator loyaltypvpserver (Canary) ---"
            ...
            lang[Step4Title]="--- KROK 4: Pobieranie kodu loyaltypvpserver ---"
            lang[Step4Clone]="Klonowanie repozytorium loyaltypvpserver (galaz: %s) do Twojego katalogu domowego (~/loyaltypvpserver)..."
            lang[Step4Exists]="Katalog loyaltypvpserver juz istnieje. Pomijanie klonowania."
...
# -- Step 4: Clone Loyalty PVP Server
info "${lang[Step4Title]}"
cd "$HOME"
if [ ! -d "loyaltypvpserver" ]; then
    printf "${lang[Step4Clone]}\n" "$BRANCH_NAME"
    git clone -b "$BRANCH_NAME" https://github.com/Leo32onGIT/loyaltypvpserver.git
else
...
cd "$HOME/loyaltypvpserver"
echo "${lang[Step6Copy]}"
# Assuming build places binaries in build/bin
cp build/bin/loyaltypvpserver .

echo "${lang[Step6Perms]}"
sudo chmod +x loyaltypvpserver

info "${lang[DoneTitle]}"
echo "${lang[DonePath]}"
echo "  $HOME/loyaltypvpserver/loyaltypvpserver"
echo ""